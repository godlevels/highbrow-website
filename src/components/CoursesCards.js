        ...
        <div className='container mx-auto'>
            <div className='grid md:grid-cols-2 gap-x-4 mx-12 mt-10'>
                <div className='bg-white shadow-lg rounded-2xl p-8'>
                    ...
                    <button className='border border-[#002E5A] text-[14px] font-normal mt-3 rounded-full py-1 px-3 hover:bg-[#002e5a] hover:text-white transition duration-300 ease-in'>Learn More</button>
                </div>
