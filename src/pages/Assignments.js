...
import Side from '../img/assignment/frames.png'
...
import SideC from '../img/assignment/circle.svg'
...
<div className='mx-auto container'>
    ...
    <div className='flex justify-between bg-[#F3F0EB] rounded-full mx-12 py-2 px-4'>
        <div className='flex gap-2'>
            ...
            <h1 className='text-[#1a1a1a] text-[18px] font-medium'>Assignments & Projects</h1>
        </div>
    </div>
        ...
        <div>
            <div className='flex gap-52'>
                <div className='mt-[200px]'>
                    <h1 className='capitalize text-[#F3F0EB] text-[48px] font-bold'>We Provide the <span className='text-[#DA7717]'>Best</span> <br /> Assignment Assistance.</h1>
                    <p className='text-[#F3F0EB] text-[16px]'>Secure your grades with us and embark on your path to academic <br /> excellence.</p>
                </div>
                <div>
    ...
    <div className='pt-[900px] mx-12'>
        <p className='text-[#1A1A1A] text-[16px] mb-5 mx-20 mt-14'>Highbrow Research is the ideal companion for guiding and assisting you with your assignments and projects. We offer high quality assignment <br /> help to all the students and learners for essay assignments, dissertation writing, thesis, assessment and all types of coursework. <br /> When assisting with your projects and assignments, our researchers employ the most effective methods to derive the perfect results. Our <br /> writers have UK educational backgrounds with a minimum of a master’s degree. Our research assistance also covers every field ranging from <br /> sciences, law, engineering, and business/management. </p>
