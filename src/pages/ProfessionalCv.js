...
<div className='mx-auto container'>
    ...
    <div className='pt-[900px] mx-12'>
        <p className='text-[#1A1A1A] text-[16px] mb-5 mx-20'>We write ATS compliant CVs. An ATS-compliant resume is a document created in a way that lets the applicant tracking system parse <br /> the application with ease. Specifically, you would get the following from this service:</p>
        <div className='mx-20'>
            <div className='flex gap-14'>
                <img src={Lines} alt="" />
                <ul className='text-[#1a1a1a] list-disc'>
                    <li className='text-[16px]'>An ATS compliant CV/Resume tailored to your specific job application or opportunity</li>
                    <li className='text-[16px]'>A CV highlighting your core skill sets, previous experiences and your accomplishments to</li>
                    <li className='text-[16px]'>showcase your abilities & potentials</li>
                    <li className='text-[16px]'>The appropriate format, layout &amp; template to make your CV easy to read and attractive to recruiters</li>
                    <li className='text-[16px]'>A winning CV that stands out and land you the job interview</li>
                </ul> 
            </div>
        </div>
