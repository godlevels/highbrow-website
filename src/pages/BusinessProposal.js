...
import SideC from '../img/businessproposals/circle.png'
...
<div className='mx-auto container'>
    ...
    <div className='pt-[900px] mx-12'>
        <p className='text-[#1A1A1A] text-[16px] mb-5'>Our business proposal is a top opportunity to win new business. It is the ultimate sales document, a condensed version of your <br /> solution to a client’s problem. Each part of our business proposal entails thoughtful planning and development.</p>
        <h1 className='text-[#1a1a1a] text-[20px] font-semibold my-4'>Our Business Proposal Outline</h1>
        <div className='flex gap-20'>
            <div className='flex gap-14'>
                <img src={Lines} alt="" />
                <ul className='text-[#1a1a1a] list-disc'>
                    <li className='text-[16px]'>Title or cover page</li>
                    <li className='text-[16px]'>Table of contents (optional but useful for longer proposals)</li>
            ...
            <div className='flex gap-14'>
                ...
                <ul className='text-[#1a1a1a] list-disc'> 
                    ...
                    <li className='text-[16px]'>Case studies and/or testimonials (optional but recommended)</li>
