...
<div className='mx-auto container'>
    ...
    <div className='pt-[900px] mx-12'>
        <p className='text-[#1A1A1A] text-[16px] mb-5'>Our business profile is an introduction to your business and aims to tell an audience about your products or services. Our <br /> business profile doesn’t just tell your audience what you sell; it also tells them why you sell it.</p>
        <h1 className='text-[#1a1a1a] text-[20px] font-semibold my-4'>Our Business Profile Outline</h1>
